...
def create_wh_zh_requests():
    ...
    dataset_name_temps = {
        'WH' : 'NonCascade_WHToA1A2_A1ToTauTau_A2ToBB_MA1-{__MASS1__}-MA2-{__MASS2__}_Filter_Tune{__TUNE__}_13TeV_madgraph_pythia8',
        'ZH' : 'NonCascade_ZHToA1A2_A1ToTauTau_A2ToBB_MA1-{__MASS1__}-MA2-{__MASS2__}_Filter_Tune{__TUNE__}_13TeV_madgraph_pythia8',
    }
...
def create_vbf_ggh_requests():
    ...
    gridpack_location_temps = {
        ...
        'ggH': {
            2016 : '/cvmfs/cms.cern.ch/phys_generator/gridpacks/pre2017/13TeV/madgraph/V5_2.6.5/ggh3_M125_Toh1h2_M{__MASS2__}_M{__MASS1__}/v1/ggh3_M125_Toh1h2_M{__MASS2__}_M{__MASS1__}_slc7_amd64_gcc700_CMSSW_9_3_16_tarball.tar.xz',
    ...
    dataset_name_temps = {
        'VBF' : 'NonCascade_VBFHToA1A2_A1ToTauTau_A2ToBB_MA1-{__MASS1__}-MA2-{__MASS2__}_Filter_Tune{__TUNE__}_13TeV_madgraph_pythia8',
        'ggH' : 'NonCascade_ggHToA1A2_A1ToTauTau_A2ToBB_MA1-{__MASS1__}-MA2-{__MASS2__}_Filter_Tune{__TUNE__}_13TeV_madgraph_pythia8'
    }
